            ...
            <form onSubmit={login}>
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <input name="usuario" value={usuarioLogin.usuario} type="text" required className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Seu email" value={usuarioLogin.usuario}
              ...
              <div className="mt-8">
                ...
                <div className="relative flex items-center">
                  <input name="senha" value={usuarioLogin.senha} type="password" required className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Sua senha" value={usuarioLogin.senha}
                    onChange={(e: ChangeEvent<HTMLInputElement>) => atualizarEstado(e)} />
