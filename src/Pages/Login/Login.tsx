...
=======
                  <input name="usuario" type="text" required className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Seu email" value={usuarioLogin.usuario}
>>>>>>> f5cfe173289674454db12b0201c12bd6f216b3a9
...
=======
                  <input name="senha" type="password" required className="w-full text-gray-800 text-sm border-b border-gray-300 focus:border-blue-600 px-2 py-3 outline-none" placeholder="Sua senha" value={usuarioLogin.senha}
>>>>>>> f5cfe173289674454db12b0201c12bd6f216b3a9
                    onChange={(e: ChangeEvent<HTMLInputElement>) => atualizarEstado(e)} />
