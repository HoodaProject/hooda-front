      ...
      <div className="min-h-screen flex flex-col items-center justify-center">
        <div className="grid md:grid-cols-2 items-center gap-4 max-md:gap-8 max-w-7xl max-md:max-w-lg w-full p-4 m-4 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md">
          <div className="md:max-w-md w-full px-4 py-4">
            <form onSubmit={login}>
              <div className="mb-12">
                <h3 className=" text-3xl font-Docker-One text-hoodaLaranja">
                  Login
                </h3>
                <p className="text-sm mt-4 text-gray-800">
                  ...
                  <Link
                    to="/register"
                    className="text-black hover:text-hoodaLaranja font-semibold hover:underline ml-1 whitespace-nowrap"
                  >
                    Cadastre-se
                  </Link>
                </p>
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
                ...
                <div>
                  <a
                    ...
                    className="text-black font-semibold hover:text-hoodaLaranja text-sm hover:underline"
                  >
                    Esqueceu sua senha?
                  </a>
                </div>
